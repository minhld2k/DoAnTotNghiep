...
<form action="/phongdaotao/tkb/create" method="post" id="formAdd">
	<div class="mb-3">
		<h1 class="h3 d-inline align-middle">Thêm mới lịch học</h1>
	</div>
	<div class="modal-body">
		<div class="form-group">
			<input type="hidden" class="form-control" id="idAdd" name="id" value="0">
			<input type="hidden" class="form-control" id="lopId" name="lopId" value="<%=lopId%>">
		</div>
		<table class="table table-bordered table-hover table-striped">
			<thead>
				<tr style="color:#d59100">
					<th>Ca học<strong>*</strong> </th>
					<th>Ngày <strong>*</strong></th>
					<th>Môn học <strong>*</strong></th>
					<th>Phòng học</th>
					<th>Lời nhắn PDT</th>
				</tr>
			</thead>
			<tbody>
				...
				<tr>
					...
					<td>
						<select class="form-control" id="monId" name="monId[]">
			                ...
			                <% for(Object[] mon : lsMon){ %>
			                    <option value="<%=mon[0].toString() %>" ><%= mon[1].toString() %></option>
			                <% } %>
			             </select>
					</td>
					<td>
					...
					<td>
						<textarea rows="1" class="form-control" id="moTa" name="moTa[]" ></textarea>
					</td>
				</tr>
				<% } %>
			</tbody>
