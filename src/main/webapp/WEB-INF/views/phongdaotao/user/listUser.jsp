...
<div class="container-fluid p-0">
	<div class="mb-3">
		...
		<% if(CommonUtil.checkQuyenByKhoa(_user.getId(), "ADD_USER")){ %>
		...
		<div class="card-body">
			<div class="viewForm box">
				<div class="row">
					...
					<div class="col-lg-6" >
						<label for="name" class="mr-sm-2">Nhóm :</label>
...
function loadMore(ten,nhomId) {
	ajaxRuning = 1;
	var count = $(".ul-cn li").length;
	$.ajax({
		async: true,
		url: "/phongdaotao/user/loadmore",
		type: "GET",
		dataType: "html",
		data: {
			'count' : count,			
...
function xoaUser(userId,nhomId) {
    var checked = false;
    $.confirm({
        'title': "",
...
function loadChiTiet(userId, nhomId) {
	var url = "/phongdaotao/user/xemChiTiet";
	var name = 'Chi tiết người dùng';
